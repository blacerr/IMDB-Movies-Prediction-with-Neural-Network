...
1. Projenin GitHub sayfasında [Issues](https://github.com/mustafayaliniz/IMDB-Movies-Prediction-with-Neural-Network/issues) sekmesine gidin.
...
2. Kendi forkladığınız projeyi yerel bilgisayarınıza klonlayın:
    ```bash
    git clone https://github.com/kendi-kullanici-adiniz/IMDB-Movies-Prediction-with-Neural-Network.git
    ```
